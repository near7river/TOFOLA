<?php
	...
	$english = array(
		...
		//settings
			...
			'tidypics:settings:multilimit' => 'Multi-Photo Uploader Limit',
			...
			'tidypics:settings:embed_river_enabled' => "Add river entry when uploading photos through the embed plugin", 
		...
		//forms
			...
			'tidypics:uploader:limit' => 'You can upload up to %s photos at a time (%s MB maximum per photo)', 
...
The photo can be viewed here: %s",
		...
		//  river
			...
			'image:river:created:multiple' => "%s added the photos: %s to album %s",
